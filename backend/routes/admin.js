...
// Middleware pentru verificarea adminului pe toate rutele
router.use(authUtils.authenticateToken.bind(authUtils));
router.use(authUtils.requireAdmin.bind(authUtils));
